...
export default function VIP() {
  return (
    <section id="vip" className="min-h-screen flex flex-col items-center justify-center py-20 px-6 sm:px-8 md:px-12 lg:px-16">
      <Reveal className="flex flex-col items-center text-center mb-14 w-full">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        {/* Carte Shop */}
        <Reveal className="group tech-corners bg-gradient-to-b from-[#0a1118] to-[#03070b] border border-gray-800/80 hover:border-cyan-400/30 hover:shadow-[0_0_30px_rgba(0,240,255,0.05)] rounded-[2.5rem] p-10 sm:p-12 lg:p-14 flex flex-col items-center text-center transition-all duration-500">
