          ...
          >
            ...
            <div className="relative flex items-center gap-6 z-10">
              ...
              <div className="flex flex-col">
                <span className="font-syne font-black text-2xl md:text-3xl tracking-[0.2em] text-white group-hover:text-[#00F2FF] transition-colors duration-500 uppercase">Instagram</span>
                <span className="font-manrope text-white/40 text-xs tracking-widest uppercase mt-1 group-hover:text-white/70 transition-colors">Le Visuel</span>
              </div>
            </div>
